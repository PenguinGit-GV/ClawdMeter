...
| `Scanning for 'Clawdmeter'… Device not found` | Clawdmeter is off, out of range, or not advertising | Power on the device and ensure it is powered on and in range |
